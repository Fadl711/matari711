    ...
    @auth
        ...
        @if (Auth::user()->usertype == 'admin2' or Auth::user()->usertype == 'admin')
            <a href="{{ route('dashboard') }}"
                class="p-5 px-8 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                لوحة التحكم</a>
                ...
                <div class="rounded overflow-hidden shadow-lg flex flex-col h-full cursor-pointer hover:shadow-xl transition-shadow"
                    ...
                    <div class="relative">
                        <a href="{{ Route('posts.show', $item->id) }}">
                            @if ($item->imgart != null)
                                <img loading="lazy" class="w-full h-40 border border-t-bro object-contain bg-gray-100"
                    ...
                    <div class="px-6 py-4 mb-auto">
                        <div
                            class="font-medium text-lg  hover:text-bro transition duration-500 ease-in-out inline-block mb-2">
                            {{ $item->titleart }}
                        </div>
