    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" 
            ...
            <div class="mb-6">
                ...
                <div class="border-2 border-dashed border-cream-300 rounded-xl p-6 text-center hover:border-primary-400 transition-colors">
                    <input type="file" 
                           name="image" 
                           accept="image/*"
                           class="hidden" 
        ...
        <div class="mt-8 bg-white rounded-2xl shadow-xl p-6 md:p-8">
            <h2 class="text-xl font-bold text-brown-700 mb-4">
