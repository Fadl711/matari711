...
<nav x-data="{ open: false }" class="bg-primary-500 shadow-lg sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="flex items-center space-x-2 rtl:space-x-reverse">
                    ...
                    <span class="text-white font-bold text-lg hidden sm:block">رواق العلوم الشرعية</span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-3 rtl:space-x-reverse">
                ...
                @else
                    <a href="{{ route('login') }}" 
                       class="text-white hover:text-gold-300 transition-colors px-3 py-2">
                        تسجيل الدخول
                    </a>
                @endauth
            </div>
    ...
    <div x-show="open" 
         ...
         class="md:hidden bg-primary-600"
         style="display: none;">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="relative">
            <input type="text" 
                   ...
                   placeholder="ابحث في المقالات والكتب..."
                       ...
                       class="flex items-center gap-4 p-4 hover:bg-cream-100 transition-colors border-b border-cream-200 last:border-0">
                        ...
                        <div class="flex-grow min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="text-xs bg-primary-100 text-primary-600 px-2 py-0.5 rounded-full" x-text="post.section"></span>
                            </div>
